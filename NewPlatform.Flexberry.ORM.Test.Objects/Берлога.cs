...
namespace NewPlatform.Flexberry.ORM.Tests
{
    ...
    public class Берлога : ICSSoft.STORMNET.DataObject
    {
        ...
        private NewPlatform.Flexberry.ORM.Tests.Лес fЛесРасположения;
        
        private NewPlatform.Flexberry.ORM.Tests.Медведь fМедведь;
        ...
        [PropertyStorage(new string[] {
                "ЛесРасположения"})]
        public virtual NewPlatform.Flexberry.ORM.Tests.Лес ЛесРасположения
        {
            get
            {
                ...
                NewPlatform.Flexberry.ORM.Tests.Лес result = this.fЛесРасположения;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку NewPlatform.Flexberry.ORM.Tests.Медведь.
        /// </summary>
        ...
        [PropertyStorage(new string[] {
                "Медведь"})]
        public virtual NewPlatform.Flexberry.ORM.Tests.Медведь Медведь
        {
            get
            {
                ...
                NewPlatform.Flexberry.ORM.Tests.Медведь result = this.fМедведь;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View LoadTestView
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("LoadTestView", typeof(NewPlatform.Flexberry.ORM.Tests.Берлога));
                }
            }
            ...
            public static ICSSoft.STORMNET.View БерлогаE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("БерлогаE", typeof(NewPlatform.Flexberry.ORM.Tests.Берлога));
                }
            }
        }
    }
    ...
    public class DetailArrayOfБерлога : ICSSoft.STORMNET.DetailArray
    {
        ...
        //  *** Start programmer edit section *** (NewPlatform.Flexberry.ORM.Tests.DetailArrayOfБерлога members)

        //  *** End programmer edit section *** (NewPlatform.Flexberry.ORM.Tests.DetailArrayOfБерлога members)
        ...
        /// </summary>
        public DetailArrayOfБерлога(NewPlatform.Flexberry.ORM.Tests.Медведь fМедведь) : 
                base(typeof(Берлога), ((ICSSoft.STORMNET.DataObject)(fМедведь)))
        {
        }
        
        public NewPlatform.Flexberry.ORM.Tests.Берлога this[int index]
        {
            get
            {
                return ((NewPlatform.Flexberry.ORM.Tests.Берлога)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(NewPlatform.Flexberry.ORM.Tests.Берлога dataobject)
        {
