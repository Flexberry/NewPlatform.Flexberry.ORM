...
(
	...
	"CanBeNull" RAW(16) NULL,

	"CanNotBeNull" RAW(16) NOT NULL,
...
(
	...
	"HierarchyClassWithIRCD" RAW(16) NOT NULL,
...
(
	...
	"HierarchyClassWithIRND" RAW(16) NOT NULL,
...
(
	...
	"First" RAW(16) NOT NULL,

	"Second" RAW(16) NOT NULL,
...
ALTER TABLE "HierarchyClassWithIRCD"
	ADD CONSTRAINT "HierarchyClassWithIRCD_FH_8283" FOREIGN KEY ("Parent") REFERENCES "HierarchyClassWithIRCD" ("primaryKey");
...
ALTER TABLE "ClassToTestIRND"
	ADD CONSTRAINT "ClassToTestIRND_FHierarch_1993" FOREIGN KEY ("CanBeNull") REFERENCES "HierarchyClassWithIRND" ("primaryKey");

CREATE INDEX "ClassToTestIRND_ICanBeNull" on "ClassToTestIRND" ("CanBeNull");

ALTER TABLE "ClassToTestIRND"
	ADD CONSTRAINT "ClassToTestIRND_FHierarch_1994" FOREIGN KEY ("CanNotBeNull") REFERENCES "HierarchyClassWithIRND" ("primaryKey");
...
ALTER TABLE "DetailForIRCD"
	ADD CONSTRAINT "DetailForIRCD_FHierarchyC_8925" FOREIGN KEY ("HierarchyClassWithIRCD") REFERENCES "HierarchyClassWithIRCD" ("primaryKey");

CREATE INDEX "DetailForIRCD_IHierarchyCl_231" on "DetailForIRCD" ("HierarchyClassWithIRCD");
...
ALTER TABLE "ClassToTestIRCD"
	ADD CONSTRAINT "ClassToTestIRCD_FHierarch_4974" FOREIGN KEY ("CanNotBeNull") REFERENCES "HierarchyClassWithIRCD" ("primaryKey");

CREATE INDEX "ClassToTestIRCD_ICanNotBeNull" on "ClassToTestIRCD" ("CanNotBeNull");

ALTER TABLE "ClassToTestIRCD"
	ADD CONSTRAINT "ClassToTestIRCD_FHierarch_4975" FOREIGN KEY ("CanBeNull") REFERENCES "HierarchyClassWithIRCD" ("primaryKey");
...
ALTER TABLE "HierarchyClassWithIRND"
	ADD CONSTRAINT "HierarchyClassWithIRND_FH_5302" FOREIGN KEY ("Parent") REFERENCES "HierarchyClassWithIRND" ("primaryKey");
...
ALTER TABLE "DetailForIRND"
	ADD CONSTRAINT "DetailForIRND_FHierarchyC_5944" FOREIGN KEY ("HierarchyClassWithIRND") REFERENCES "HierarchyClassWithIRND" ("primaryKey");

CREATE INDEX "DetailForIRND_IHierarchyC_6403" on "DetailForIRND" ("HierarchyClassWithIRND");
...
ALTER TABLE "ClassWithMaster"
	ADD CONSTRAINT "ClassWithMaster_FClassToT_4520" FOREIGN KEY ("First") REFERENCES "ClassToTestIRND" ("primaryKey");

CREATE INDEX "ClassWithMaster_IFirst" on "ClassWithMaster" ("First");

ALTER TABLE "ClassWithMaster"
	ADD CONSTRAINT "ClassWithMaster_FClassToT_6430" FOREIGN KEY ("Second") REFERENCES "ClassToTestIRCD" ("primaryKey");
