...
CREATE TABLE [ClassToTestIRND] (
	 ...
	 [CanBeNull] UNIQUEIDENTIFIER  NULL,

	 [CanNotBeNull] UNIQUEIDENTIFIER  NOT NULL,
...
CREATE TABLE [DetailForIRCD] (
	 ...
	 [HierarchyClassWithIRCD] UNIQUEIDENTIFIER  NOT NULL,
...
CREATE TABLE [DetailForIRND] (
	 ...
	 [HierarchyClassWithIRND] UNIQUEIDENTIFIER  NOT NULL,
...
CREATE TABLE [ClassWithMaster] (
	 ...
	 [First] UNIQUEIDENTIFIER  NOT NULL,

	 [Second] UNIQUEIDENTIFIER  NOT NULL,
...
CREATE INDEX InformationTestClass2_IInformationTestClass_m1 on [InformationTestClass2] ([InformationTestClass_m1])
 ...
 ALTER TABLE [HierarchyClassWithIRCD] ADD CONSTRAINT [HierarchyClassWithIRCD_FHierarchyClassWithIRCD_0] FOREIGN KEY ([Parent]) REFERENCES [HierarchyClassWithIRCD]
CREATE INDEX HierarchyClassWithIRCD_IParent on [HierarchyClassWithIRCD] ([Parent])
...
CREATE INDEX cla_Iparent on [cla] ([parent])
 ...
 ALTER TABLE [ClassToTestIRND] ADD CONSTRAINT [ClassToTestIRND_FHierarchyClassWithIRND_0] FOREIGN KEY ([CanBeNull]) REFERENCES [HierarchyClassWithIRND]
CREATE INDEX ClassToTestIRND_ICanBeNull on [ClassToTestIRND] ([CanBeNull])

 ALTER TABLE [ClassToTestIRND] ADD CONSTRAINT [ClassToTestIRND_FHierarchyClassWithIRND_1] FOREIGN KEY ([CanNotBeNull]) REFERENCES [HierarchyClassWithIRND]
CREATE INDEX ClassToTestIRND_ICanNotBeNull on [ClassToTestIRND] ([CanNotBeNull])
...
CREATE INDEX AuditAgregatorObject_IMasterObject on [AuditAgregatorObject] ([MasterObject])
 ...
 ALTER TABLE [DetailForIRCD] ADD CONSTRAINT [DetailForIRCD_FHierarchyClassWithIRCD_0] FOREIGN KEY ([HierarchyClassWithIRCD]) REFERENCES [HierarchyClassWithIRCD]
CREATE INDEX DetailForIRCD_IHierarchyClassWithIRCD on [DetailForIRCD] ([HierarchyClassWithIRCD])
...
CREATE INDEX Кредит_IКлиент on [Кредит] ([Клиент])
 ...
 ALTER TABLE [ClassToTestIRCD] ADD CONSTRAINT [ClassToTestIRCD_FHierarchyClassWithIRCD_0] FOREIGN KEY ([CanNotBeNull]) REFERENCES [HierarchyClassWithIRCD]
CREATE INDEX ClassToTestIRCD_ICanNotBeNull on [ClassToTestIRCD] ([CanNotBeNull])

 ALTER TABLE [ClassToTestIRCD] ADD CONSTRAINT [ClassToTestIRCD_FHierarchyClassWithIRCD_1] FOREIGN KEY ([CanBeNull]) REFERENCES [HierarchyClassWithIRCD]
CREATE INDEX ClassToTestIRCD_ICanBeNull on [ClassToTestIRCD] ([CanBeNull])
...
CREATE INDEX AuditMasterObject_IMasterObject on [AuditMasterObject] ([MasterObject])
 ...
 ALTER TABLE [HierarchyClassWithIRND] ADD CONSTRAINT [HierarchyClassWithIRND_FHierarchyClassWithIRND_0] FOREIGN KEY ([Parent]) REFERENCES [HierarchyClassWithIRND]
CREATE INDEX HierarchyClassWithIRND_IParent on [HierarchyClassWithIRND] ([Parent])
...
CREATE INDEX Перелом_IЛапа_m0 on [Перелом] ([Лапа_m0])
 ...
 ALTER TABLE [DetailForIRND] ADD CONSTRAINT [DetailForIRND_FHierarchyClassWithIRND_0] FOREIGN KEY ([HierarchyClassWithIRND]) REFERENCES [HierarchyClassWithIRND]
CREATE INDEX DetailForIRND_IHierarchyClassWithIRND on [DetailForIRND] ([HierarchyClassWithIRND])
...
CREATE INDEX ComputedDetail_IComputedMaster on [ComputedDetail] ([ComputedMaster])
 ...
 ALTER TABLE [ClassWithMaster] ADD CONSTRAINT [ClassWithMaster_FClassToTestIRND_0] FOREIGN KEY ([First]) REFERENCES [ClassToTestIRND]
CREATE INDEX ClassWithMaster_IFirst on [ClassWithMaster] ([First])

 ALTER TABLE [ClassWithMaster] ADD CONSTRAINT [ClassWithMaster_FClassToTestIRCD_0] FOREIGN KEY ([Second]) REFERENCES [ClassToTestIRCD]
CREATE INDEX ClassWithMaster_ISecond on [ClassWithMaster] ([Second])
