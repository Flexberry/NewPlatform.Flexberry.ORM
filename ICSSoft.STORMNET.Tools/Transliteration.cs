namespace ICSSoft.STORMNET.Tools
{
    ...
    {
        //TODO: ivashkevich: переписать алгоритм - бежать по строке, заменять по символу, искать в словаре (для обратного перевода - тоже словарь), использовать стрингбилдер
        /// <summary>
