...
namespace NewPlatform.Flexberry.ORM.Tests
{
    ...
    public class Перелом : ICSSoft.STORMNET.DataObject
    {
        ...
        private NewPlatform.Flexberry.ORM.Tests.ТипПерелома fТип;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View k_ПереломE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("k_ПереломE", typeof(NewPlatform.Flexberry.ORM.Tests.Перелом));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ПереломD
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПереломD", typeof(NewPlatform.Flexberry.ORM.Tests.Перелом));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ПереломE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПереломE", typeof(NewPlatform.Flexberry.ORM.Tests.Перелом));
                }
            }
        }
    }
    ...
    public class DetailArrayOfПерелом : ICSSoft.STORMNET.DetailArray
    {
        ...
        /// </summary>
        public DetailArrayOfПерелом(NewPlatform.Flexberry.ORM.Tests.Лапа fЛапа) : 
                base(typeof(Перелом), ((ICSSoft.STORMNET.DataObject)(fЛапа)))
        {
        }
        
        public NewPlatform.Flexberry.ORM.Tests.Перелом this[int index]
        {
            get
            {
                return ((NewPlatform.Flexberry.ORM.Tests.Перелом)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(NewPlatform.Flexberry.ORM.Tests.Перелом dataobject)
        {
