...
namespace NewPlatform.Flexberry.ORM.Tests
{
    ...
    public class Конкурс : ICSSoft.STORMNET.DataObject
    {
        ...
        private NewPlatform.Flexberry.ORM.Tests.Состояние fСостоятие;
        ...
        public virtual NewPlatform.Flexberry.ORM.Tests.Состояние Состоятие
        {
            get
            {
                ...
                NewPlatform.Flexberry.ORM.Tests.Состояние result = this.fСостоятие;
